...
interface ICurveModule {
     ...
     */
    function calculateExit(uint256 liquidAssets, uint256 debtCommitments, uint256 lAmount) external view returns (uint256);
     ...
     */
    function calculateExitInverseWithFee(uint256 liquidAssets, uint256 debtCommitments, uint256 pAmount) 
    external view returns (uint256 withdraw, uint256 withdrawU, uint256 withdrawP);
}