...
export interface CoreContract extends Truffle.Contract<CoreInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<CoreInstance>;
}
...
export interface CoreInstance extends Truffle.ContractInstance {
  abiOf(
