...
export interface GSNContextContract
  extends Truffle.Contract<GSNContextInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<GSNContextInstance>;
}
...
export interface GSNContextInstance extends Truffle.ContractInstance {
  initialize: {
    (txDetails?: Truffle.TransactionDetails): Promise<
      Truffle.TransactionResponse
    >;
